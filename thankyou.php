...
<link rel="stylesheet" href= "https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.4/css/fontawesome.min.css">  
  ...
  <body>
    <section class="header">
      <nav>
         <a href="thankyou.php"><img src= "logo.png"></a>
        ...
        <div class="text-box">
          <h1>Your message has been sent!</h1>
           <p>Thank you for your message. We have recieved it and now our team will make sure to return your message within 48hrs.</p>
                  
                  <a href="start.php" class="button">Click here to continue</a>
        </div>     
   </section>
  </body>
</html>